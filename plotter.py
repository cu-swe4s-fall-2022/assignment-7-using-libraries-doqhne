...
for species_name in set(iris['species']):
    ...
    plt.scatter(iris_subset['sepal_length'], iris_subset['sepal_width'], label=species_name, s=5)
...
for species_name in set(iris['species']):
    iris_subset = iris[iris['species'] == species_name]
    axes[1].scatter(iris_subset['sepal_length'], iris_subset['sepal_width'], label=species_name, s=5)
